...
//        Response<List<Employee>> listResponse2 = employeeClient.find(employee);
    ...
    public String checkschedule(HttpServletRequest request, Model model, Schedule schedule) {
...
//        schedule2.setStartTime(DateTimeUtils.stringToDate(schedule.getStartTimes()));
//        schedule2.setEndTime(DateTimeUtils.stringToDate(schedule.getEndTimes()));
...
//        schedule.setStartTime(DateTimeUtils.stringToDate(schedule.getStartTimes()));
//        schedule.setEndTime(DateTimeUtils.stringToDate(schedule.getEndTimes()));
    ...
    public String saveAll(HttpServletRequest request, Model model, Schedule schedule) {
