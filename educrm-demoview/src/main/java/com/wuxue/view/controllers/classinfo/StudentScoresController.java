...
public class StudentScoresController extends BaseController
        implements IQueryController<StudentScores, String>, ISaveController<StudentScores, String>,IQueryByPagingController<StudentScores,Map<String,Object>>,
     ...
     */
    @Override
    public String query(HttpServletRequest request, Model model, StudentScores studentScores) {
    ...
    public String save(HttpServletRequest request, Model model, StudentScores studentScores) {
        ...
        studentScores.setYear(DateTimeUtils.stringToDate(studentScores.getYearTime()));
    ...
    public String saveAll(HttpServletRequest request, Model model, LinkmanList scores ) {
        ...
        if (list != null && list.size()>0){
            for (StudentScores studentScores : list) {
                ...
                studentScores.setPkEmployee(SessionCache.getUserCode());
                studentScores.setModifier(SessionCache.getUserCode());
                studentScores.setYear(DateTimeUtils.stringToDate(studentScores.getYearTime()));
            }
        }
        return studentScoresClient.saveAll(list);
