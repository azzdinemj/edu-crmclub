...
<form class="look form-ajax" method="POST" id="formId" action="/course/courseList/save" data-target="/course/courseListUs/query" >
                ...
                <div class="col-xs-12 col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-md-9">
                            ...
                            <#if dict??>
                                <#list dict as v >
                                    <option  <#if course.types?? && v.pkSysDictValues??&& course.types==v.pkSysDictValues></#if> value="${(v.pkSysDictValues)!}">
                                    ${(v.caption)!}
                                    </option>
                                </#list>
                            </#if>
