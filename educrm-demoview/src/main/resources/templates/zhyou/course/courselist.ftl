...
<#if course??>
    ...
    <#--<#list 1..course.pages as v>-->
        <#--<li ><a href="/course/courseList/query?pageNo=${v}">${v}</a></li>-->
    <#--</#list>-->
...
//            $.post('/course/courseList/delete', {"pkCourse": id}, function(data) {
//                if (data.code == 0) {
//                    Notify.success(data.message);
//                    setTimeout("location.reload()", 1);
//                } else {
...
//            },"json");
    ...
    function query() {
        ...
        $("#queryCourse").attr("href","/course/courseList/query?isissue="+isissue+"&&caption="+caption)[0].click();
    }
