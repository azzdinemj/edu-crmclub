...
<div class="contentpanel">
    ...
    <div class="panel panel-default pl35">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                        <input type="hidden" name="questionsSubjectId" id="pkParent" value="${(questions.questionsSubjectId)!}"  class="form-control"
                           title="">
                        <#--<input  id="pkParentcaption" readonly value="${(questions.questionsSubjectName)!}" class="form-control"<#if questions ??&& questions.questionsSubjectId??><#else >data-toggle="modal"-->
                               <#--data-target="#modal" data-url="/question/questionSubject/querylist"</#if> >-->
                    <input  name="questionsSubjectName" id="pkParentcaption" readonly value="${(questions.questionsSubjectName)!}" class="form-control" data-toggle="modal"
                            data-target="#modal" data-url="/question/questionSubject/querylist" >
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <textarea id="title" class="validate[required]" style="width:100%;height:200px" name="title" >
                        ${(questions.title)!}
                    </textarea>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <div class="pos-rel">
                        <input type="radio" <#if questions??&&questions.rank??&&questions.rank==3>checked="" </#if> name="rank" id="rank" size="70" value="3" checked="" /> 易&nbsp;&nbsp;
                        <input type="radio" <#if questions??&&questions.rank??&&questions.rank==2>checked="" </#if> name="rank" id="rank" size="70" value="2" />中&nbsp;&nbsp;
                        <input type="radio" <#if questions??&&questions.rank??&&questions.rank==1>checked="" </#if> name="rank" id="rank" size="70" value="1"  />难
                    </div>
