...
<div class="contentpanel">
    <div class="pageheader">
        <h2><i class="fa fa-bookmark"></i>讲师类型<span>...</span></h2>
        <div class="breadcrumb-wrapper">
            <div class="btn-group fr title-btn">
                <a class="btn btn-sm btn-newblue" href="/lecturer/lecturertype/edit">新建类型</a>
        ...
        <div class="panel-body pd0">
            <div class="table-responsive">
                <table id="table"  class="table  table-bordered" cellspacing="0">
                    ...
                    <tr>
                        <td>56</td>
                        <td><a class="yellow" href="/lecturer/lecturertype/edit">班课</a></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td>
