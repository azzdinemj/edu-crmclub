    ...
    <div class="signinpanel">
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-xs-12">
                <div class="logo text-center cl">
                    <#--<img src="images/lilogo.png">-->
                    <img src="http://sjj.crmclub.cn/files/lilogo.png" onerror="this.src='images/lilogo.png'">
                </div>
                <form id="formid" class="form-loginajax" method="post" action="/signon" data-target="/sigonindex">
                    ...
                    <input type="submit" class="btn btn-news mb15 btn-block login" value="登录"></input>

                    <div class="row mt15">
                        <div class="col-xs-6 text-center"><a href="/login">中文</a></div>

                        <div class="col-xs-6 text-center"><a href="/login_en">English</a></div>
                    </div>
                </form>
