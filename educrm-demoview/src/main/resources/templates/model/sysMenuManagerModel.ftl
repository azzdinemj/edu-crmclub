...
<script type="text/javascript">
    ...
    function query() {
       ...
       // init(columns,"/system/sysMenuManager/queryByPaging",data,"pagingTable");
        init(GetTableColumn("sysMenuManagerModel"), "/system/sysMenuManager/queryByPaging", data,"pagingTable");
    }
