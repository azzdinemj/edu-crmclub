...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>课程老师管理 <span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-newblue" data-toggle="modal" data-target="#modal" data-url="/classinfo/courseTeacher/create" >配置课程</a>
...
//        {"sTitle":"老师","data":"pkEmployee"},
        ...
        {"sTitle":"性别","data" : "map.employeeEntity.sex","render": function (data){
            if (data==1){ return '男';}
            else {return '女'; }
        }}
    ];
    ...
    function query() {
        ...
        init(columns,"/classinfo/courseTeacher/queryByPaging",data,"pagingTable");
    }
