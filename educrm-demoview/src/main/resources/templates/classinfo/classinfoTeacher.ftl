                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="col-xs-9">
                                ...
                                <#if classinfo??>
                                    <#list classinfo as j>
                                        <option value="${(j.pkClassinfo)!}">${(j.caption)!}</option>
                                    </#list>
                                </#if>
                                </select>
                            </div>
...
//        {"sTitle":"排序","data" : "sort"} ,
    ...
    function querys() {
        ...
        init(columns2,"/system/employee/queryByPaging",data2,"pagingTable2");
    }


    function saveBtn() {
        var pkEmployee = $("input[name='radio1']:checked").val();
        ...
        $.ajax({
            type: "POST",
            url: "/classinfo/classinfoTeacher/save",
