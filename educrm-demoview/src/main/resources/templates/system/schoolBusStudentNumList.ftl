...
<div class="contentpanel">
    <div class="pageheader">
        <h2><i class="fa fa-bookmark"></i>校车报表<span>...</span></h2>
...
<script type="text/javascript">
    ...
    var columns = [
        ...
        {"sTitle":"校车编号","data":"code"},
        {"sTitle":"校车名称","data":"caption"},
        {"sTitle":"乘坐人数","data":"stunum"}
    ...
    function query() {
        ...
        init(columns,"/system/schoolBusStudentNum/queryByPaging",data,"pagingTable");
    }
