        ...
        <div class="modal-body">
            <form class="form-ajax form-horizontal" method="post" action="/system/employeeCertificate/save"
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-lg-4">
                        <input  name="cer.dateTime" value="${(employeeCertificate.dateTime)!}" class="form-control js-datepicker" data-bv-notempty data-bv-notempty-message="请录入时间" title="" type="text">
                    </div><!-- /.col -->
