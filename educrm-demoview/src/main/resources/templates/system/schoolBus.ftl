...
<form class="form-ajax form-horizontal no-margin look" id="formid" method="post" action="/system/schoolBus/save" data-target="/system/schoolBus/query">
    ...
    <div class="contentpanel">
        <div class="pageheader">
            ...
            <div class="breadcrumb-wrapper">
                <div class="btn-group fr title-btn">
                    ...
                    <#--<a class="btn btn-newblue btn-sm" data-toggle="modal" data-target="#myModal" data-url="change-bus.html">-->
                        <#--编辑-->
                    <#--</a>-->
                    <#--<a class="btn btn-newblue btn-sm" data-toggle="modal" data-target="#myModal" data-url="info-bus.html">-->
                        <#--入住-->
                    <#--</a>-->
                    <#--<a class="btn btn-newblue btn-sm" data-toggle="modal" data-target="#myModal" data-url="out-bus.html">-->
                        <#--退宿-->
                    <#--</a>-->
                </div>
            </div>
        ...
        <div class="panel panel-default">
            ...
            <input type="hidden" name="bus.pkSchoolBus" value="${(schoolBus.pkSchoolBus)!}">
            <div class="contentpanel">
                               ...
                               <div class="form-group">
                                   ...
                                   <div class="col-xs-9 col-md-9">
                                       ...
                                       <span class="rdio rdio-warning">
                                                   <input name="bus.isvalid" value="0" class="deldis"
                                                          <#if schoolBus.isvalid??&& schoolBus.isvalid ==1 ><#else >checked="checked"</#if>
                                                          id="radio1" type="radio">
                                                   <label for="radio1">启用</label>
                                               </span>
                                       <span class="rdio rdio-warning">
                                                   <input name="bus.isvalid" value="1" id="radio2" class="deldis"
                                                          <#if schoolBus.isvalid??&& schoolBus.isvalid ==1 >checked="checked"</#if>
                                                          type="radio">
