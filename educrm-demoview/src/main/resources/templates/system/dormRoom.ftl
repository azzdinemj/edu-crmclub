...
<form class="form-ajax form-horizontal no-margin look" id="formid" method="post" action="/system/dormRoom/save" data-target="/system/dormRoom/query">
    ...
    <div class="contentpanel">
        ...
        <div class="panel panel-default">
            ...
            <input type="hidden" name="room.pkDormRoom" value="${(dormRoom.pkDormRoom)!}">
            <div class="contentpanel">
                           ...
                           <div class="row">
                               ...
                               <div class="col-xs-12 col-md-4">
                                   <div class="form-group">
                                       ...
                                       <div class="col-xs-9 col-md-9">
                                           <select name="housemaster" class="selectpicker show-tick form-control" multiple data-live-search="true">
                                               <#if housemasters ??>
