                    ...
                    <div class="tab-content">
                        <div id="all" class="tab-pane active">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-xs-3 col-md-3">计入退费</label>
                                        <div class="col-xs-4 col-md-4 pt7">
                                            <div class="rdio rdio-warning">
                                                <input  id="radio1" name="exp.refund" value="1" <#if expenseItem.isvalid??&& expenseItem.isvalid==0><#else >checked="checked" </#if> type="radio">
                                                <label for="radio1">是</label>
                                            </div>
                                        </div>
                                        <div class="col-xs-4 col-md-4 pt7">
                                            <div class="rdio rdio-warning">
                                                <input  id="radio2" name="exp.refund" value="0" <#if expenseItem.isvalid??&& expenseItem.isvalid ==0>checked="checked"</#if>type="radio">
