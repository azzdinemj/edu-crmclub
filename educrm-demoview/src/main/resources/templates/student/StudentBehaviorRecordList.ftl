...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>学生违规处分<span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal" data-url="/student/studentBehaviorRecord/create">新建学生处分</a>
                    ...
                    <div class="table-responsive">
                        <table id="table"  class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th width="250">年级</th>
                                <th width="300">处分时间</th>
                                <th width="200">事件情形</th>
                                <th width="200">处分</th>
                            </tr>
                            </thead>
                            <tbody>
