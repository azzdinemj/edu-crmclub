...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>学生奖励<span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal" data-url="/student/studentAwards/create">新建学生奖励</a>
                    ...
                    <div class="table-responsive">
                        <table id="table"  class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th width="250">年级</th>
                                <th width="300">奖项级别</th>
                                <th width="200">活动名称</th>
                                <th width="200">获奖时间</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
