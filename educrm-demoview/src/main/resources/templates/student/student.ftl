...
<div class="pageheader">
    ...
    <div class="breadcrumb-wrapper">
        ...
        <#if student.istype?? && student.istype ==0 >
            <a class="btn btn-sm btn-newblue" href="/student/studentInterview/create?pkStudent=${(student.pkStudent)!}">面试</a>
            <a class="btn btn-sm btn-newblue"
               href="/student/studentReport/create?pkStudent=${(student.pkStudent)!}">报名</a>
        </#if>
        </div>
    </div>
</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <input name="stu.passportDateTime"
                                               value="${(student.passportDate?string("yyyy-MM-dd"))!}" type="text"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9"><input name="stu.inState" value="${(student.inState)!}"
                                                                 type="text"
                                                                 class="form-control">
                                    </div>
                                </div>
                            ...
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        ...
                                        <#--<input type="hidden" id="pkempid" name="stu.pkSysUser" value="${(employee.pkEmployee)!}"  class="form-control" >-->
