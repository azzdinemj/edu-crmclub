...
<div class="contentpanel">
    <div class="pageheader">
        <h2><i class="fa fa-bookmark"></i>请假列表 <span>...</span></h2>
        <div class="breadcrumb-wrapper">
            <div class="btn-group fr title-btn">
                <a class="btn btn-sm btn-newblue" href="/student/studentaskforleave/edit">新建</a>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var columns = [
        ...
        {"sTitle":"学生名称","data" : "stuEmpCaption",
        ...
        {"sTitle":"请假科目","data" : "map.sysDictValues.caption","render":function (data) {
            if (data==null){ return '';}
            else {return data; }
        }},
