...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>社会实践活动 <span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal" data-url="/classinfo/classinfoActivity/create">新建</a>
                ...
                <div class="panel-body pd0">
                    <div class="table-responsive">
                        <table id="table"  class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tbody>
                            <tr>
                                <td><a class="btn btn-success btn-sm"  data-toggle="modal" data-target="#modal" data-url="/classinfo/classinfoActivity/edit">修改</a></td>
                                <td>LM123456</td>
                                <td>差旅</td>
                                <td>春游</td>
                                <td>春游</td>
