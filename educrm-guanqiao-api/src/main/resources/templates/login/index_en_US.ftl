...
<#include "../commons/left.ftl"/>
    ...
    <div class="pageheader">
        <h2><i class="fa fa-home"></i>home page <span>...</span></h2>
        <div class="breadcrumb-wrapper">
            <span class="label">Your position:</span>
            <ol class="breadcrumb">
                <li><a href="index.ftl">Return</a></li>
            ...
            <div class="row home">
                                            ...
                                            <div class="user-name">
                                                <div class="panel-heading">
                                                    <div class="panel-btns">
                                                        <a href="" title="Close the message" class="panel-close">×</a>
                ...
                <#--<div class="col-lg-6 col-md-6 col-xs-12">-->
                    <#--<div class="social-widget left-widget">-->
                        <#--<div class="smart-widget">-->
                            ...
                            <#--<div class="paddingTB-sm paddingLR-md panel">-->
                                <#--<div class="m-bottom-md clearfix">-->
                                <#--&lt;#&ndash;<div class="user-profile-pic clearfix">-->
                                    <#--<img src="images/photos/blog3.jpg" alt="">-->
                                <#--</div>&ndash;&gt;-->
                                    <#--<div class="user-name">-->
                                        <#--<div class="panel-heading">-->
                                ...
                                <#--&lt;#&ndash; <div class="user-profile-pic clearfix">-->
                                 ...
                                 <#--</div>&ndash;&gt;-->
                                    <#--<div class="user-name">-->
                                        ...
                                        <#--<div class="panel-body">-->
                                            <#--<p class="m-top-sm">-->
                                                <#--Charge for success：<a href="/">Lili</a>-->
                                            <#--</p>-->
                                            <#--<i>2017-05-06</i>-->
                                        <#--</div>-->
                                    <#--</div>-->
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="social-widget">
                        <div class="smart-widget">
                            <div class="smart-widget-header">
                                <a href="#addanything" title="Additions" data-toggle="modal" class="btn btn-sm pull-right"><i class="fa fa-plus"></i></a>
                                My task
                            </div>
                    ...
                    <div class="smart-widget-body">
                        <form class="form-horizontal no-margin" method="post">
                            <div class="form-group">
                                <label class="control-label col-lg-3">Matter</label>
                                <div class="col-lg-9">
                            ...
                            <div class="form-group">
                                ...
                                &lt;#&ndash;<div class="modal-footer">&ndash;&gt;
                                    &lt;#&ndash;<button type="button" class="btn btn-default btn-sm" data-dismiss="modal">cancel&ndash;&gt;
                                    &lt;#&ndash;</button>&ndash;&gt;
                                    &lt;#&ndash;<button type="submit" class="btn btn-info btn-sm" data-dismiss="modal">Determine</button>&ndash;&gt;
                                &lt;#&ndash;</div>&ndash;&gt;
                        </form>
