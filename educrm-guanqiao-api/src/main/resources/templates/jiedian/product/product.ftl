                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 col-md-3">
                            <select name="pro.status" class="form-control">
                                <option <#if product??&&product.status??&&product.status==1> selected="" </#if> value="1">启用</option>
                                <option <#if  product??&&product.status??&&product.status==0> selected="" </#if>  value="0">禁用</option>
                            </select>
                        </div>
                    </div>
                </div>
