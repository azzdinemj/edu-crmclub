            ...
            <div class="breadcrumb-wrapper">
                <div class="btn-group fr title-btn">
                    ...
                    <#--<input class="btn btn-sm btn-newblue" type="submit" value="保存">-->
                        <a class="btn btn-sm btn-newblue"  onclick="saveB()" >保存</a>
                        <#if delete?? && delete==1>
            ...
            <div class="row">
                 ...
                 <div class="col-lg-6 col-xs-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 ">
                            <input class="form-control js-datetimepicker"  value="${(schedule.startTime? string("yyyy-MM-dd HH:mm"))!}" name="startTimes" type="text" data-bv-notempty data-bv-notempty-message="请选择开始时间">
                        </div>
                    </div>
                </div>
                 <div class="col-lg-6 col-xs-12 col-md-12">
                    <div class="form-group">
                        ...
                        <div class="col-xs-9 ">
                            <input class="form-control js-datetimepicker"  value="${(schedule.endTime? string("yyyy-MM-dd HH:mm"))!}" name="endTimes" type="text" data-bv-notempty data-bv-notempty-message="请选择结束时间">
                        </div>
                    </div>
                </div>
                <#if bykey ?? && bykey=="1">
...
function saveB() {
//    var isfee = $('input:radio:checked').val();
    var isfeedbackNum =$('input:radio:checked').val();
    var statusNum =${(schedule.status)!0};
    if (isfeedbackNum ==1){
        if(statusNum ==0){
            Notify.danger("该课程未上，不能反馈");
            return false;
        }
    }
