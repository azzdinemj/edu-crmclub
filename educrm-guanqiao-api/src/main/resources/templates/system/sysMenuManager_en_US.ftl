...
<div class="contentpanel">
    <div class="pageheader">
        <h2><i class="fa fa-bookmark"></i>add menu<span>...</span></h2>
    ...
    <div class="panel panel-default pl35">
        ...
        <div class="form-group row">
            ...
            <label class="control-label col-xs-2 col-md-2">English name</label>
            <div class="col-xs-4 col-md-4">
        ...
        <div class="form-group">
            <label class="control-label col-xs-2 col-md-2">Primary</label>
            <div class="col-xs-4 col-md-4">
            ...
            <label class="control-label col-xs-2 col-md-2">Parent key</label>
            <div class="col-xs-4 col-md-4">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-4 col-md-4">
                ...
                <#--<option  value="1" <#if responseSysmenu.isdisplay?? && responseSysmenu.isdisplay==1 >selected="selected"</#if> >display</option>-->
                <#--<option  value="0" <#if responseSysmenu.isdisplay?? && responseSysmenu.isdisplay==0 >selected="selected"</#if> >not display</option>-->

                    <option <#if responseSysmenu??&& responseSysmenu.isdisplay?? && responseSysmenu.isdisplay==1> SELECTED</#if> value="1" >display</option>
                    <option <#if responseSysmenu??&& responseSysmenu.isdisplay?? && responseSysmenu.isdisplay==0> SELECTED</#if> value="0" >not display</option>
        ...
        <div class="form-group ">
            ...
            <label class="control-label col-xs-2 col-md-2">address</label>
            <div class="col-xs-4 col-md-4">
