        ...
        <div class="modal-body">
            <form class="form-ajax form-horizontal" method="post" action="/system/employeeJobExp/save"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        <input  name="ejob.startdateTime" value="${(employeeJobExp.startdate?string("yyyy-MM-dd"))!}" class="form-control js-datepicker" data-bv-notempty data-bv-notempty-message="Please enter the start time" title="" type="text">
                    </div><!-- /.col -->

                    <label class="control-label col-lg-2">End time</label>
                    <div class="col-lg-4">
                        <input name="ejob.enddateTime" value="${(employeeJobExp.enddate?string("yyyy-MM-dd"))!}" class="form-control js-datepicker" data-bv-notempty data-bv-notempty-message="Please enter the end time" title="" type="text">
                    </div><!-- /.col -->
                </div>
                <div class="form-group row">
                    <label class="control-label col-lg-2">Work unit</label>
                    <div class="col-lg-4">
                        <input name="ejob.jobUnit" value="${(employeeJobExp.jobUnit)!}" class="form-control" data-bv-notempty data-bv-notempty-message="Please enter the work unit" title="" type="text">
                    </div><!-- /.col -->
