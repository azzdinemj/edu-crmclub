...
<div class="contentpanel">
    <div class="pageheader">
        <h2><i class="fa fa-bookmark"></i>添加考点<span>...</span></h2>
    ...
    <div class="panel panel-default pl35">
        ...
        <#--<div class="form-group">-->
            ...
            <#--<div class="col-xs-4 col-md-4">-->
                <#--<input name="id" readonly value="${(questions.id)!}" class="form-control"-->
                       <#--title="" type="text">-->
            <#--</div><!-- /.col &ndash;&gt;-->
        ...
        <div class="form-group">
            <input name="id"  value="${(questions.id)!}" class="form-control" title="" type="hidden">
            <label class="control-label col-xs-2 col-md-2">名称</label>
            <div class="col-xs-4 col-md-4">
                <input name="name" value="${(questions.name)!}" class="form-control" title="" type="text" placeholder="知识点名称" data-bv-notempty="" data-bv-notempty-message="请录入知识点名称">
            </div><!-- /.col -->
        </div>
