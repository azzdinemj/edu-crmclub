...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>Class teacher management <span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-newblue" data-toggle="modal" data-target="#modal" data-url="/classinfo/classinfoTeacher/create" >Configure the teacher class</a>
...
//    ];
    ...
    function query() {
        var data  = { "dateTime": $("#datas").val(),"caption":$("#caption").val(),"isvalid":"1"};
        init(GetTableColumn("classinfoTeacher"),"/classinfo/classinfoTeacher/queryByPaging",data,"pagingTable");
    }
    ...
    function del() {
        ...
        var pkClassinfo = getTableSelectRow("pagingTable",index).pkClassinfo;
        ...
        if (flag) {
            $.ajax({
                type: "POST",
                url: "/classinfo/classinfoTeacher/delete",
