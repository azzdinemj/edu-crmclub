...
public class SessionCache {
    ...
    private static final String STR_CODE="strCode";//验证码
    ...
    public static String getStrCode() {
        Object obj = getRequest().getSession().getAttribute(STR_CODE);
        if (obj == null) {
            return "";
        }
        return obj.toString();
    ...
    public static String getPk() {
        Object obj = getRequest().getSession().getAttribute(PK);
        if (obj == null) {
            return "";
        }
        return obj.toString();
    ...
    public static void setPk(String pk) {
        getRequest().getSession().setAttribute(PK, pk);
    }
...
//        Object obj = getRequest().getSession().getAttribute(F_Url);
...
//        getRequest().getSession().setAttribute(F_Url, url);
        ServletContext servletContext = getRequest().getSession().getServletContext();
        String servletPath = getRequest().getServletPath();
        System.out.print(servletPath);
        getRequest().getSession().setAttribute(F_Url,getRequest().getServletPath());
    }
}
