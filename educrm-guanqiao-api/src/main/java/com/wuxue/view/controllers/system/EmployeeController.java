...
public class EmployeeController extends BaseController implements IQueryController<Employee, String>, ISaveController<Employee, String>,IQueryByPagingController<Employee,Map<String,Object>>,
        ICreateController<Employee,  Map<String,Object>>, IEditController<Employee,  Map<String,Object>>, IDeleteController<Employee, String> {
...
//        model.addAttribute("list", listResponse.getData());
    ...
    @Override
    @ResponseBody
    public  Map<String,Object> create(HttpServletRequest request, Model model, Employee employee) {
    ...
    public Map<String,Object> edit(HttpServletRequest request, Model model, Employee employee) {
