...
public class StudentSpecialtyController extends BaseController
        implements IQueryController<StudentSpecialty,String>,ISaveController<StudentSpecialty, String>,IQueryByPagingController<StudentSpecialty,Map<String,Object>>,
...
//        model.addAttribute("student",listResponse.getData());
    ...
    @Override
    @ResponseBody
    public Map<String, Object> queryByPaging(HttpServletRequest request, HttpServletResponse response, StudentSpecialty studentSpecialty, Integer sEcho, Integer start, Integer length) {
        studentSpecialty.setPageNo((start/length)+1);
        studentSpecialty.setPageSize(length);
