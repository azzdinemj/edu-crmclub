                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <input name="stu.caption" value="${(student.caption)!}"  type="text" class="form-control"
                                               placeholder="姓名" data-bv-notempty="" data-bv-notempty-message="请录用户的名称">
                                    </div>
                                </div>
                            </div><!-- col-sm-4 -->
                            <div class="col-xs-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <input name="stu.phone" value="${(student.phone)!}"  type="text" class="form-control"
                                               placeholder="个人电话" data-bv-notempty="" data-bv-notempty-message="请录入个人电话">
                                    </div>
                                </div>
                            </div><!-- col-sm-4 -->
                        </div>
                            ...
                            <div class="col-xs-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-11 col-md-11">
                                        <textarea class="form-control" name="stu.memo" rows="3" placeholder="备注" >
                                        ${(student.memo)!}
                                        </textarea>
                                    </div>
                                </div>
