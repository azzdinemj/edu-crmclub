                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9 col-md-10">
                                <input name="caption" value="${(Lessonname.caption)!}" class="form-control"
                                       title="" type="text" placeholder="课时名称" data-bv-notempty="" data-bv-notempty-message="请录入课时名称">
                            </div><!-- /.col -->
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-xs-9 col-md-10">
                                <select name="type" class="form-control">
                                    ...
                                    <option <#if Lessonname.type??&& Lessonname.type=='4' > selected</#if> value="1">
                                        pdf
                                    </option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-9 col-md-10">
                                <select name="status" class="form-control">
                                    <option <#if Lessonname.status?? && Lessonname.status==0 > selected</#if> value="0" selected >
                                        开放
                                    </option>
