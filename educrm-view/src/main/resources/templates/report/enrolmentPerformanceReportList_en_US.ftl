...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>Admissions teacher's performance statistics <span>...</span></h2>
...
<script type="text/javascript">
    ...
    var columns = [
        {"sTitle":"Admissions teacher","data":"caption"},
        {"sTitle":"Enrollment number","data" : "studentnum"},
        {"sTitle":"Already enrolment","data" : "membernum"},
    ];
//    var data  = [];
//    init(columns,"/classinfo/classinfo/queryByPaging",data)
    ...
    function query() {
        var data  = {};
        init(GetTableColumn("enrolmentPerformance"),"/report/enrolmentPerformanceReport/queryByPaging",data,"pagingTable");
    }
