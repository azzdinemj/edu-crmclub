...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>StudentStatusReport <span>...</span></h2>
...
<script type="text/javascript">
    ...
    var columns = [
        {"sTitle":"公司","data":"domainname"},
        {"sTitle":"年级","data" : "gradename"},
        {"sTitle":"项目","data" : "programname"},
        {"sTitle":"收入","data" : "income"},
        {"sTitle":"退费","data" : "refund"}
    ];
//    var data  = [];
//    init(columns,"/classinfo/classinfo/queryByPaging",data)
    ...
    function query() {
        var data  = {};
        init(GetTableColumn("studentStatusReport"),"/report/studentStatusReport/queryByPaging",data,"pagingTable");
    }
