...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>课程统计表 <span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-newblue" onclick="queryTeacherCourese()" >老师报表</a>
                        <a class="btn btn-sm btn-newblue" onclick="querystudentCourese()" >学生报表</a>
                    </div>
                </div>
            </div>
                ...
                <div class="panel  panel-alt widget-quick-status-post mb0 bor0">
                    <div class="panel-heading pd10 bor0 new">
                        ...
                        <form class="form-inline search white">
                            ...
                            <div class="form-group">
                                   <span id="queryBy" class="btn btn-newblue btn-sm search" ><i class="fa fa-search"> </i>搜索</span>
                           </div>
                        </form>
