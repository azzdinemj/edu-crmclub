...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>Class student statistics <span>...</span></h2>
...
<script type="text/javascript">
    ...
    var columns = [
        {"sTitle":"Class name","data":"classname"},
        {"sTitle":"Headmaster","data" : "headteachername"},
        {"sTitle":"second teacher","data" : "secondteachername"},
        {"sTitle":"Number of lodging","data" : "stuboardnum"},
        {"sTitle":"Number of lodging（男）","data" : "gg"},
        {"sTitle":"Number of lodging（女）","data" : "mm"},
        {"sTitle":"Total","data" : "number"}
    ];
//    var data  = [];
