...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>financial statements <span>...</span></h2>
...
<script type="text/javascript">
    ...
    var columns = [
        {"sTitle":"company","data":"domainname"},
        {"sTitle":"grade","data" : "gradename"},
        {"sTitle":"project","data" : "programname"},
        {"sTitle":"income","data" : "income"},
        {"sTitle":"Refund","data" : "refund"}
    ];
//    var data  = [];
//    init(columns,"/classinfo/classinfo/queryByPaging",data)
    ...
    function query() {
        var data  = {};
        init(GetTableColumn("financeReport"),"/report/financeReport/queryByPaging",data,"pagingTable");
    }
