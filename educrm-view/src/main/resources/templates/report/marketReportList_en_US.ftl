...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>Market Report <span>...</span></h2>
...
<script type="text/javascript">
    ...
    var columns = [
        {"sTitle":"project","data":"caption","render" : renderMarketStatus},
        {"sTitle":"男","data" : "gg"},
        {"sTitle":"女","data" : "mm"},
        {"sTitle":"Total number","data" : "numbers"}
    ];
//    var data  = [];
//    init(columns,"/classinfo/classinfo/queryByPaging",data)
    ...
    function query() {
        var data  = {};
        init(GetTableColumn("marketReport"),"/report/marketReport/queryByPaging",data,"pagingTable");
    }
