...
<div class="pageheader">
    ...
    <div class="breadcrumb-wrapper">
        <div class="btn-group fr title-btn">
            ...
            <a class="btn btn-sm btn-newblue " id="reject" data-toggle="modal" data-target="#myModal" onClick="reject()">驳回</a>
                            ...
                            <div class="modal-content">
                                ...
                                <form id="formModelId">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <label class="control-label col-xs-2">驳回意见</label>
                                            <div class=" col-xs-10">
...
//}
    ...
    $("#buttonId").click(function () {
        ...
        var id = $("#pkStudentSignup").val();
        if (id == null || id == ""){
            Notify.danger("未找到审核信息");
            return false;
        }

        $.ajax({
            type:"POST",
            url:"/finance/studentSignupAudit/reject",
            data:{"auditOpinion":auditOpinion,"pkStudentSignup":id},
            dataType:"json",
            success:function (data) {
                if (data.code==0){
                    Notify.success(data.message);
