        ...
        <div class="panel-body pd0">
            <div class="">
                ...
                <#if (classTeacherList?size > 0)>
                    ...
                    <#else >
                        Class teachers have no data，Unable to arrange classes，Please come back after the configuration is finished。
                    </#if>
...
//                    alert(JSON.stringify(scheduleList))
                        ...
                        Notify.danger("There is no choice in the classroom");
                        return false;
                    }
                }else{
                    Notify.danger("No choice of courses");
                    return false;
                }
            }
        });
