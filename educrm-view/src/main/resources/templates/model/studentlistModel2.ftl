                ...
                <form>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <select id="pkClassinfo" name="pkClassinfo" class="id_select_center form-control">
...
<script type="text/javascript">
    ...
    function query() {
        var data  = { "code": $("#code").val(),"caption":$("#caption").val(),"pkClassinfo":$("#pkClassinfo").val(),"istype":"1"};
