                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9 col-md-9">
                                       <#-- <input class="form-control" value="${(student.caption)!}" readonly title=""
                                           ...
                                           <input id="stuCaption" readonly value="${(student.map.caption)!}" class="form-control" <#if student ??&& student.pkStudent??><#else >data-toggle="modal" data-target="#modal" data-url="/classinfo/classinfo/findstu?pkClassinfo=${(classinfo.pkClassinfo)!}"</#if> >
                            ...
                            <div class="col-xs-12 col-md-4">
                                        ...
                                        <#if grade ??>
                                            <#list grade as gra>
                                                <option value="${(gra.pkSysDictValues)!}"
                                                        <#if reportkey?? && reportkey==2&& gra.pkSysDictValues ?? && student.grade??&& gra.pkSysDictValues==student.grade> disabled selected="selected"</#if>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col-xs-9 col-md-9">
                                        <select name="stu.schoolYear" class="form-control" class="selectpicker bla bla bli" data-live-search="true">
                                        <#if schoolYear ??>
                                            <option value="">请选择</option>
                                            <#list schoolYear as p>
                                                <option value="${(p.pkSysDictValues)!}" <#if p.pkSysDictValues ?? && student.schoolYear ?? && p.pkSysDictValues==student.schoolYear>selected</#if>>${(p.caption)!}</option>
                                            </#list>
                                        </#if>
                                        </select>
                                    </div><!-- /.col -->
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class=" col-xs-11">
                                        <textarea rows="1" name="stu.memo"
                                                  class="form-control" title="">${(student.memo)!}</textarea>
                                    </div><!-- /.col -->
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9 col-md-9 pt7">
                                       <span class="rdio rdio-success">
                                           ...
                                           <input name="stu.issubmit" value="1" id="radio1" disabled class="deldis"
