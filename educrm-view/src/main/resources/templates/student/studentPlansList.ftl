...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>学业规划<span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal" data-url="/student/studentPlans/create">新建记录</a>
                    ...
                    <div class="table-responsive">
                        <table id="table"  class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th width="200">申请国家</th>
                                <th width="250">选择大学因素</th>
                                <th width="300">喜欢的科目</th>
                                <th width="200">擅长的科目</th>
                                <th width="200">希望学什么专业</th>
                                <th width="200">期望从事的工作</th>
                                <th width="200">毕业后规划</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <td><a class="success" data-toggle="modal" data-target="#modal" data-url="/student/studentPlans/edit">微微</a></td>
                                <td>美国</td>
                                <td>喜欢</td>
                                <td>化学</td>
                                <td>化学</td>
