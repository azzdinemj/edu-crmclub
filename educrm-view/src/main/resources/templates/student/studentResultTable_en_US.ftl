...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>Transcript<span>...</span></h2>
                <div class="breadcrumb-wrapper">
                 <!--   <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-danger" data-toggle="modal" data-target="#myModal" data-url="">delete</a>
                        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal" data-url="new_student_planing.html">New record</a>

                        &lt;!&ndash;     <button title="operations" type="button" class="btn btn-success btn-sm dropdown-toggle" data-toggle="dropdown">
                    ...
                    <div class="table-responsive">
                        <table id="table"  class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><a class="success" href="/student/studentTestPlansScores/edit">slightly</a></td>
                                <td>U.S.A</td>
                                <td>like</td>
                                <td>Chemistry</td>
