...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>Student punishment<span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal" data-url="/student/studentBehaviorRecord/create">add</a>
                    ...
                    <div class="table-responsive">
                        <table id="table"  class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th width="300">disposition time</th>
                                <th width="200">Event situation</th>
                                <th width="200">Punishment</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <td>ldmk</td>
                                <td>
                                    <a class="success" data-toggle="modal" data-target="#modal" data-url="/student/studentBehaviorRecord/edit">
                                        slightly
                                    </a>
                                </td>
                                <td>second grade</td>
                                <td>2018-7-8</td>
                                <td>English competition</td>
                                <td>8</td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" class="px"></td>
