        ...
        <div class="modal-body">
            <form class="form-horizontal no-margin form-ajax" method="post" action="/student/studentSpecialty/save"
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <label class="control-label col-lg-3">Duration study</label>
                        <div class="col-lg-9">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="control-label col-lg-3">special hobby</label>
                        <div class="col-lg-9">
                            <input  class="form-control" name="stu.specialty" data-bv-notempty data-bv-notempty-message="Please enter the specialty" title="" type="text">
                        </div><!-- /.col -->
                    </div>
                    <div class="form-group">
                        <label class="control-label col-lg-3">Award achievement</label>
                        <div class="col-lg-9">
