...
<div class="contentpanel">
    <div class="pageheader">
        <h2><i class="fa fa-bookmark"></i>My students <span>...</span></h2>
        <div class="breadcrumb-wrapper">
            ...
            <#-- <button title="operations" type="button" class="btn btn-newblue btn-sm dropdown-toggle" data-toggle="dropdown">
             ...
             <ul class="dropdown-menu" role="menu">
                 <li><a href="" data-toggle="modal" onclick="del()"> delete </a></li>
             </ul>-->
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function query() {
        ...
        init(GetTableColumn("student"), "/student/mystudent/queryByPaging", data,"pagingTable");
    }
    function del() {
