...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>reward<span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal" data-url="/student/studentAwards/create">add</a>
                    ...
                    <div class="table-responsive">
                        <table id="table"  class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th width="300">Award level</th>
                                <th width="200">Activity name</th>
                                <th width="200">Award time</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <td>
                                    <a class="success" href="/student/studentAwards/edit">
                                        slightly
                                    </a>
                                </td>
                                <td>second grade</td>
