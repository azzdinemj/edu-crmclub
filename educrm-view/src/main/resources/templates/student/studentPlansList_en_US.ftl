...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>planning<span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <a class="btn btn-sm btn-success" data-toggle="modal" data-target="#modal" data-url="/student/studentPlans/create">New record</a>
                    ...
                    <div class="table-responsive">
                        <table id="table"  class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <th width="200">application Country</th>
                                <th width="250">University selection factors</th>
                                <th width="300">favorite subject</th>
                                <th width="200">good subject</th>
                                <th width="200">Planning profession</th>
                                <th width="200">Work expected.</th>
                                <th width="200">Graduation plan</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                ...
                                <td><a class="success" data-toggle="modal" data-target="#modal" data-url="/student/studentPlans/edit">slightly</a></td>
                                <td>U.S.A</td>
                                <td>like</td>
                                <td>Chemistry</td>
                                <td>Chemistry</td>
