    ...
    <div class="pageheader">
        ...
        <div class="breadcrumb-wrapper">
            <div class="btn-group fr title-btn">
                <a class="btn btn-sm btn-newblue" href="/individual/optionalCourse/save" onclick="save()">Preservation</a>
            </div>
        </div>
    </div>
...
//        if (data==1){ return 'activated';}
//        else if(data==0){return 'not active'; }
//    }
