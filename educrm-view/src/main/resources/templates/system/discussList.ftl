...
<#include "../commons/left.ftl" />
        ...
        <div class="contentpanel">
            <div class="pageheader">
                <h2><i class="fa fa-bookmark"></i>留言板 <span>...</span></h2>
                <div class="breadcrumb-wrapper">
                    <div class="btn-group fr title-btn">
                        <#--<a class="btn btn-sm btn-info" href="/setMeal/setMeal/create" >添加</a>-->
                    ...
                    <div class="panel-heading pd10 bor0 new">
                        <form class="form-inline search white">
                            ...
                            <div class="form-group">
                                <label></label>
                                <div class="btn-group">
                                    <button type="button" onclick="query()"  class="btn btn-info btn-sm">查询</button>
                                </div>
                            </div>
                        </form>
...
<script>
    ...
    function query() {
        ...
        init(GetTableColumn("discuss"),"/discuss/discuss/queryByPaging",data,"pagingTable");
    }

    function renderDiscussEdit(data, type, row) {
        return '<a href="/discuss/discuss/edit?studentId='+row.studentId+'" class="yellow" >'+data+'</a>';
    }

    function renderNumbner(data, type, row) {
        if(data == null){
            return 0;
        }else{
            return data;
