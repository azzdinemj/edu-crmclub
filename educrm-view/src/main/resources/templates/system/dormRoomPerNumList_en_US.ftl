...
<div class="contentpanel">
    <div class="pageheader">
        <h2><i class="fa fa-bookmark"></i>Dormitory Report<span>...</span></h2>
...
//    var columns = [
//        {"sTitle":"campus","data" : "map.domainEntity.caption"} ,
//        {"sTitle":"Dorm type","data":"kind","render": function (data){
//            if (data==0){ return 'Student dorm';}
//            else {return 'Teacher dorm'; }
//        }},
//        {"sTitle":"sex","data":"sex","render": function (data){
//            if (data==1){ return '男';}
//            else {return '女'; }
//        }},
//        {"sTitle":"Living population","data":"num"}
//
//    ];
