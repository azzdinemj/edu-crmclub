        ...
        <div class="modal-body">
            <form class="form-ajax form-horizontal" method="post" action="/system/employeeJobExp/save"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        <input  name="ejob.startdateTime" value="${(employeeJobExp.startdate?string("yyyy-MM-dd"))!}" class="form-control js-datepicker" data-bv-notempty data-bv-notempty-message="请录入开始时间" title="" type="text">
                    </div><!-- /.col -->

                    <label class="control-label col-lg-2">结束时间</label>
                    <div class="col-lg-4">
                        <input name="ejob.enddateTime" value="${(employeeJobExp.enddate?string("yyyy-MM-dd"))!}" class="form-control js-datepicker" data-bv-notempty data-bv-notempty-message="请录入结束时间" title="" type="text">
                    </div><!-- /.col -->
                </div>
                <div class="form-group row">
