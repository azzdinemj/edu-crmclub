        ...
        <div class="modal-body">
            <form class="form-ajax form-horizontal" method="post" action="/system/employeeCertificate/save"
                ...
                <div class="form-group row ">
                    <label class="control-label col-lg-2">获得时间</label>
                    <div class="col-lg-4">
                        <input  name="cer.dateTime" value="${(employeeCertificate.date?string("yyyy-MM-dd"))!}" class="form-control js-datepicker" data-bv-notempty data-bv-notempty-message="请录入时间" title="" type="text">
                    </div><!-- /.col -->

                    <label class="control-label col-lg-2">名称</label>
                    <div class="col-lg-4">
                        <input name="cer.certificateName" value="${(employeeCertificate.certificateName)!}" class="form-control" data-bv-notempty data-bv-notempty-message="请录入名称" title="" type="text">
                    </div><!-- /.col -->
                </div>
