    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
                    ...
                    <div class="tab-content">
                        <div id="all" class="tab-pane active">
                            <div class="form-group row">
                                <label class="control-label col-xs-2 col-md-2">Login name</label>
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-2 col-md-2">Password</label>
                                <div class="col-xs-4 col-md-4">
                                    <input name="user.password" value="" class="form-control"
                                           title="" type="text">
                                </div><!-- /.col -->
                                <label class="control-label col-xs-2 col-md-2">Sex</label>
                                <div class="col-xs-4 col-md-4">
                            ...
                            <div class="form-group">
                                <label class="control-label col-xs-2 col-md-2">School area</label>
                                <div class="col-xs-4 col-md-4">
                                ...
                                <label class="control-label col-xs-2 col-md-2">Subordinate department</label>
                                <div class="col-xs-4 col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-2 col-md-2">Modified</label>
                                <div class="col-xs-4 col-md-4">
                                    <input readonly class="form-control"
            ...
            <#--<button type="submit" class="btn btn-success btn-sm">Determine</button>-->
                <input class="btn btn-newblue btn-sm saveButton" id="dosubmit" value="Preservation" type="button">
                </div>
            </form>
        </div>
