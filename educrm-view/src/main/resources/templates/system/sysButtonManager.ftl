...
<div class="contentpanel">
    <div class="pageheader">
        <h2><i class="fa fa-bookmark"></i>添加按钮<span>...</span></h2>
    ...
    <div class="panel panel-default pl35">
        ...
        <div class="col-xs-4 col-md-4">
            <select name="display" class="form-control">
                <option <#if responseSysmenu??&& responseSysmenu.display?? && responseSysmenu.display==1> SELECTED</#if> value="1" >显示</option>
                <option <#if responseSysmenu??&& responseSysmenu.display?? && responseSysmenu.display==0> SELECTED</#if> value="0" >不显示</option>
            </select>
        </div><!-- /.col -->
        </div>
