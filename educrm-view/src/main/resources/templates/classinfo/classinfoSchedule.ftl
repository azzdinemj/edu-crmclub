                    ...
                    <div class="table-responsive">
                        <table  class="table table-striped table-bordered nosort" cellspacing="0">
                            ...
                            <tr >
                                ...
                                <td><a data-toggle="modal" data-target="#modal" data-url="/classinfo/classinfoschedule/updateClassSchedule?pkSchedule=${(c.pkSchedule)!}">${(c.map.courseEntity.caption)!}</a></td>
