        ...
        <div class="contentpanel">
            <ul class="nav nav-tabs nav-yellow">
                ...
                <#if classinfo.pkClassinfo??>
                    ...
                    <li class=""><a data-toggle="tab" href="#linkMan"><strong>Parent account</strong></a></li>
                </#if>
            ...
            <form class="look form-horizontal no-margin form-ajax" id="formId" method="post" action="/classinfo/classinfo/save"
                ...
                <div class="tab-content">
                    ...
                    <div id="assigned" class="tab-pane">
                        <div class="row">
                            <div class="col-xs-12 col-md-4">
                                <label class="control-label col-xs-3 col-md-3">term</label>
                                <div class="col-xs-9 col-md-9">
                                    <select id="termId">
                            ...
                            <div class="col-xs-12 col-md-4">
                                <label class="control-label col-xs-3 col-md-3">year</label>
                                <div class="col-xs-9 col-md-9">
                                    <input id="schoolYear" class="form-control js-datepickerYYYY" >
                                </div>
                            </div>
                            <a class="btn btn-newblue btn-sm right" onclick="schoolReport()" id="schoolReportId" target="_blank">school report</a>
                            <a class="btn btn-newblue btn-sm right" data-toggle="modal" data-target="#modal" id="scoreComment" target="_blank" data-url="/classinfo/classinfo/scoreEvaluate">Performance evaluation</a>
                        </div>
                        <table id="table" class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <tr dataid="${(s.pkStudent)!}" dataCaption="${(s.caption)!}" dataScore="${(s.map.studentScoreEntity.code)!}" dataEv="${(s.map.studentScoreEntity.caption)!}">
                                ...
                                <td>
                                    <#if s.sex ?? && s.sex==1>boy<#else >girl</#if>
                                </td>
                        ...
                        <table id="pagingTableTeacher" class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <#if employees ??>
                                ...
                                <tr dataid="${(s.pkStudent)!}">
                                    ...
                                    <td>
                                        <#if es.sex ?? && es.sex==1>man<#else >woman</#if>
                                    </td>
                        ...
                        <table id="pagingTableTeacher" class="table table-striped table-bordered" cellspacing="0">
                            ...
                            <#if students ??>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <#if t.sex ?? && t.sex==1>boy<#else >girl</#if>
                                    </td>
                                    <td>
                                    ${(t.pkStudent)!}
                                    </td>
