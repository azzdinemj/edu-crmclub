...
var uploadTools = {
    ...
    "getInitOption":function(uploadId){
        ...
        var initOption={
            "uploadId":uploadId,
            "uploadUrl":"/file/batchUpload",//必须，上传地址
    ...
    "getShowFileType":function(isImg,fileType,fileName,isImgUrl,fileCodeId){
        ...
        modelStr+="<i class='iconfont icon-shanchu'>删除</i>";
        modelStr+="</div>";
    ...
    "initWithLayout":function(opt){
        ...
        if(!opt.isHiddenUploadBt){
            ...
            btsStr += "<i class='iconfont icon-shangchuan' title='上传'>上传</i>";
            btsStr += " </div>";
        }
        //清理按钮
        if(!opt.isHiddenCleanBt){
            btsStr += "<div class='cleanFileBt'>";
            btsStr += "<i class='iconfont icon-qingchu' title='删除'>删除</i>";
            btsStr += " </div>";
        }
        btsStr += "</div>";
        $("#"+uploadId+' .box').before(btsStr);
    ...
    "uploadFile":function(opt){
        var uploadUrl = "/file/batchUpload";
        var fileList = uploadFileList.getFileList(opt);
