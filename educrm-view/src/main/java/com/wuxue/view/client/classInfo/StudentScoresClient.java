...
//        Response<Object> response = JSON.parseObject(responseXml,new TypeReference<Response<Object>>(){});
    ...
    public Response<List<StudentScores>> findSchoolReport(Student studentScores){
        String responseXml = POST(getSendUrl(ActionEnum.FINDSCHOOLREPORT), studentScores);
        Response<List<StudentScores>> response = JSON.parseObject(responseXml, new TypeReference<Response<List<StudentScores>>>(){});
        return response;
    }
    public Response<Student> findSchoolReportByStudent(Student studentScores){
        String responseXml = POST(getSendUrl(ActionEnum.FINDSCHOOLREPORT), studentScores);
