...
@Service
public class QuestionsItemClient extends CourseBaseClient implements IDeleteClient<QuestionsItem,String>,
    ...
    @Override
    public String delete(QuestionsItem questionsItem) {
        String responseXml = POST(getSendUrl(ActionEnum.DELETE),questionsItem);
