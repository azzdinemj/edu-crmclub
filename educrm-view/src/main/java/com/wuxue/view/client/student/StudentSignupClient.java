...
//        Response<Object> response = JSON.parseObject(responseXml,new TypeReference<Response<Object>>(){});
    ...
    public String cancel(StudentSignup studentSignup){
        String responseXml = POST(getSendUrl(ActionEnum.CANCEL),studentSignup);
       /* Response<Object> response = JSON.parseObject(responseXml, new TypeReference<Response<Object>>(){});*/
        return responseXml;
    }
    ...
    public Response getCost(StudentSignup studentSignup) {
        String responseXml = POST(getSendUrl(ActionEnum.GETCOST),studentSignup);
        Response<Map<String,Object>> response = JSON.parseObject(responseXml,new TypeReference<Response<Map<String,Object>>>(){});
