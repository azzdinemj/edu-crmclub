...
//        Response<Object> response = JSON.parseObject(responseXml,new TypeReference<Response<Object>>(){});
    ...
    public Response<List<Student>> findArrearsStudent(Student studentSignup) {
        String responseXml = POST(getSendUrl(ActionEnum.FINDARREARSSTUDENT),studentSignup);
        Response<List<Student>> response = JSON.parseObject(responseXml,new TypeReference<Response<List<Student>>>(){});
        return response;
...
//        Response<Object> response = JSON.parseObject(responseXml, new TypeReference<Response<Object>>(){});
    ...
    @Override
    public Response audit(Student student) {
        String responseXml = POST(getSendUrl(ActionEnum.AUDIT),student);
        Response<Student> response = JSON.parseObject(responseXml, new TypeReference<Response<Student>>(){});
        return response;
    }

    public Response<List<Student>> findByClassinfo(Student student) {

        String responseXml = POST(getSendUrl(ActionEnum.FINDBYCLASSINFO),student);
        Response<List<Student>> response = JSON.parseObject(responseXml,new TypeReference<Response<List<Student>>>(){});
        return response;
    }

    public Response getStudentIdCode(String pkClassinfo) {
        String responseXml = POST(getSendUrl(ActionEnum.GETSTUDENTIDCODE),pkClassinfo);
