...
//        Response<Object> response = JSON.parseObject(responseXml,new TypeReference<Response<Object>>(){});
    ...
    public String saveAll(Receivable receivable){
        String responseXml = POST(getSendUrl(ActionEnum.SAVEALL),receivable);
        //Response<Object> response = JSON.parseObject(responseXml, new TypeReference<Response<Object>>(){});
        return responseXml;
    }

    public String cancel(Receivable receivable){
        String responseXml = POST(getSendUrl(ActionEnum.CANCEL),receivable);
        //Response<Object> response = JSON.parseObject(responseXml, new TypeReference<Response<Object>>(){});
        return responseXml;
    }

    public String saveAudit(Receivable receivable){
        String responseXml = POST(getSendUrl(ActionEnum.SAVEAUDIT),receivable);
        //Response<Object> response = JSON.parseObject(responseXml, new TypeReference<Response<Object>>(){});
        return responseXml;
    }
