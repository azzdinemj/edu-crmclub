...
public class SessionCache {
    ...
    private static final String F_QuestionList = "questionList";
...
//        getRequest().getSession().setAttribute(F_Url, url);
    ...
    public static void setQuestionList(String questionList) {
        getRequest().getSession().setAttribute(F_QuestionList, questionList);
    }

    public static String getQuestionList() {
        Object obj = getRequest().getSession().getAttribute(F_QuestionList);
        if (obj == null) {
            return "";
        }
        return obj.toString();
