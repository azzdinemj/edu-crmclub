...
//        model.addAttribute("schoolBusKind",sysDictValue);
    ...
    private void initReportPageAttribute(Model model, String pkSysDictValues) {
        ...
        employeeUtils.setJobPostModeAttribute(model,"drivers",JobPostEnum.DRIVER_TEACHER);
        employeeUtils.setJobPostModeAttribute(model,"guardianTeachers",JobPostEnum.GUARDIAN_TEACHER);
    ...
    public String edit(HttpServletRequest request, Model model, SchoolBus schoolBus) {
        ...
        model.addAttribute("bykey","false");
//        List<SysDictValues> sysDictValue = sysDictUtils.getSysDictValue(SysDicEmnuUtils.SCHOOL_BUS_KIND);
//        model.addAttribute("schoolBusKind",sysDictValue);
        initReportPageAttribute(model, SysDicEmnuUtils.SCHOOL_BUS_KIND);
    ...
    public String save(HttpServletRequest request, Model model, SchoolBus schoolBus) {
        ...
        if(bykey != null && "true".equals(bykey)){
        ...
        schoolBus.setOffschDepartDate(DateTimeUtils.getStringToDate(schoolBus.getOffschDepartDateTime(),"hh:mm"));
        schoolBus.setSchoolDepartDate(DateTimeUtils.getStringToDate(schoolBus.getSchoolDepartDateTime(),"hh:mm"));
