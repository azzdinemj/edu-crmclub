...
@Controller
@RequestMapping(value = "/jiedian/employeeTimetable")
public class EmployeeTimetableController extends BaseController implements IQueryController<Employee, String>,IQueryByPagingController<Employee,Map<String,Object>>,
