package com.wuxue.api.controller;
...
//	public static final String LOCAL_PATH = "D:/java/images/";
	...
	public Response upFileImage(@RequestParam(value = "file", required = false) MultipartFile file) {
...
//		newfile.setReadable(true,false);redirect
//        webUrl = "redirect:http://et.crmclub.cn/junhua/information.html?url="+webUrl;
...
//			}
	...
	public void upLoadImage3(HttpServletRequest request, HttpServletResponse response){
		try {
			...
			//本地站点文件保存目录路径  测试
		   String savePath = "D:/Java/apache-tomcat-9.0.6/apache-tomcat-9.0.6/webapps/files/";

		   //String savePath = "/home/data/tomcat/webapps/files/";正式环境路径
